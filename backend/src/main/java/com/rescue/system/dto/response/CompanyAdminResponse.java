...
public class CompanyAdminResponse {
    ...
    public CompanyAdminResponse() {
    }

    public CompanyAdminResponse(Long id, String name, String address, String phone, String email,
                                Double latitude, Double longitude, Double serviceRadius,
                                Boolean isActive, Double averageRating, Integer totalReviews,
                                String description, String businessLicense, Boolean isVerified,
                                ProfileStatus profileStatus, String taxCode, String hotline,
                                String operatingHours, LocalDateTime licenseExpiryDate,
                                String licenseDocumentUrl, String rejectionReason,
